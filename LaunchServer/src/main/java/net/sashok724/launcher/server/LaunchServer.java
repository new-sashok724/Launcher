...
import net.sashok724.launcher.client.serialize.config.entry.IntegerConfigEntry;
...
import net.sashok724.launcher.server.auth.handler.AuthHandler;
import net.sashok724.launcher.server.auth.provider.AuthProvider;
import net.sashok724.launcher.server.binary.EXEL4JLauncherBinary;
import net.sashok724.launcher.server.binary.EXELauncherBinary;
import net.sashok724.launcher.server.binary.JARLauncherBinary;
import net.sashok724.launcher.server.binary.LauncherBinary;
import net.sashok724.launcher.server.command.handler.CommandHandler;
import net.sashok724.launcher.server.command.handler.JLineCommandHandler;
import net.sashok724.launcher.server.command.handler.StdCommandHandler;
import net.sashok724.launcher.server.response.ServerSocketHandler;
import net.sashok724.launcher.server.texture.TextureProvider;
...
public final class LaunchServer implements Runnable {
	...
	private void generateConfigIfNotExists() throws IOException {
		...
		try (BufferedReader reader = IOHelper.newReader(IOHelper.getResourceURL("launcherserver/defaults/config.cfg"))) {
