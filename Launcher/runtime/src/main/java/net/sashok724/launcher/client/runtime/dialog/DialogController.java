package net.sashok724.launcher.client.runtime.dialog;
...
import net.sashok724.launcher.client.client.ServerPinger;
...
import net.sashok724.launcher.client.runtime.dialog.overlay.SettingsController;
import net.sashok724.launcher.client.runtime.dialog.overlay.SpinnerController;
...
public final class DialogController implements Initializable {
	...
	public DialogController(Application app, Stage stage) throws IOException {
		this.app = app;
		this.stage = stage;
		loadFXML(IOHelper.getResourceURL("net.sashok724.launcher.client.runtime/dialog/dialog.fxml"), this);
	...
	public void initOfflineMode() {
		...
		URL offlineURL;
		try {
			offlineURL = IOHelper.getResourceURL("net.sashok724.launcher.client.runtime/dialog/overlay/offline/index.html");
	...
	private final class ProfileListCell extends ListCell<SignedObjectHolder<ClientProfile>> {
		...
		private ProfileListCell(ListView<SignedObjectHolder<ClientProfile>> view) {
			setText(null);
			try {
				URL resourceURL = IOHelper.getResourceURL("net.sashok724.launcher.client.runtime/dialog/profileCell.fxml");
