...
import net.sashok724.launcher.client.hasher.FileNameMatcher;
...
import net.sashok724.launcher.client.serialize.config.entry.ConfigEntry;
...
public final class ClientProfile extends ConfigObject implements Comparable<ClientProfile> {
	...
	@LauncherAPI
	public enum Version {
		MC164("1.6.4", 78), MC172("1.7.2", 4), MC1710("1.7.10", 5), MC188("1.8.8", 47);
